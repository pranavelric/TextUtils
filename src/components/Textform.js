  ...
  return (
    <>
      <div className="mb-3">
        ...
        <button className="btn btn-primary mx-3 my-3" onClick={()=>{setText(text.toUpperCase()); props.showAlert("Text converted to uppercase","success")}}>Convert to Uppercase</button>
        <button className="btn btn-primary mx-3 my-3" onClick={()=>{setText(text.toLowerCase()); props.showAlert("Text converted to lower","success")}}>Convert to Lowercase</button>
